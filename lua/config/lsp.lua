...
require("mason-lspconfig").setup({
  ensure_installed = {
    "lua_ls", "pyright", "ts_ls", "html", "cssls", "jsonls", "yamlls", "vtsls" ,"vue_ls"
  },
})
...
vim.lsp.config('vue_ls',    { on_attach = on_attach, capabilities = capabilities })
vim.lsp.config('vtsls', {
  ...
  settings = {
    vtsls = {
      ...
      experimental = {
        completion = {
          enableServerSideFuzzySearch = true,
        },
      },
    },
    typescript = {
